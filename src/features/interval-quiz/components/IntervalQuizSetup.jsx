  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Blob 4 - very subtle center glow */}
        <motion.div
          animate={{
            x: [0, 40, -30, 0],
            y: [0, 20, -20, 0],
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(147,197,253,0.03) 0%, rgba(147,197,253,0.01) 45%, transparent 75%)",
            filter: "blur(90px)",
          }}
        />
      ...
      <div
        style={{
          ...
          margin: "0 auto",
          padding:
            "clamp(2.5rem,8vw,5rem) clamp(1.1rem,5vw,4rem) clamp(3rem,8vw,5rem)",
      ...
      >
        ...
        <motion.section
          ...
          style={{
            marginBottom: "clamp(2.5rem,8vw,4.5rem)",
          }}
        >
          <span
            style={{
          ...
          >
            Train your ears to recognize intervals
            with focused listening sessions and
        ...
        >
          ...
          >
            <div>
              ...
              >
                {selectedIntervals.length} of{" "}
                {INTERVALS.length} selected
              </p>
            </div>
          ...
          {!isValid && (
            ...
            >
              Select at least 2 intervals to
              begin.
            </p>
          )}
        </motion.section>
